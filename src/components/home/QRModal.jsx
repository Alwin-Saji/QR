  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      <div className="relative bg-black/40 backdrop-blur-2xl border border-theme-4/20 p-10 rounded-[2.5rem] shadow-[0_0_100px_rgba(0,0,0,0.8)] flex flex-col items-center gap-8 animate-in fade-in zoom-in duration-500 overflow-hidden group">
        ...
        <button onClick={onClose} className="absolute top-6 right-3 text-theme-4/50 hover:text-theme-4 bg-black/20 hover:bg-black/40 rounded-full p-2 transition-all duration-300 backdrop-blur-md">
          <X className="w-5 h-5" />
        </button>
        <div className="relative bg-gradient-to-br from-theme-3 to-theme-4 p-[3px] rounded-3xl shadow-2xl overflow-hidden transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]">
